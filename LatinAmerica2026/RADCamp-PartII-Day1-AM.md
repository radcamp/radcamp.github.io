...
* [Lecture: Intro to RADSeq (Brief)](./RADcamp-bioinformatics-lecture-1.pdf)
...
* More efficiently use tools for reproducible bioinformatics (unix, jupyter, ipyrad, etc)
...
Lead: Deren
* [ipyrad documentation](https://eaton-lab.org/ipyrad2/)
