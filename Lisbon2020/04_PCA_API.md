...
Sites before filtering: 4266
Filtered (indels): 0
Filtered (bi-allel): 84
Filtered (mincov): 0
Filtered (minmap): 0
Filtered (combined): 84
Sites after filtering: 4182
Sites containing missing values: 15 (0.36%)
Missing values in SNP matrix: 17 (0.03%)
Imputation (null; sets to 0): 100.0%, 0.0%, 0.0%
Subsampling SNPs: 985/4182
(<toyplot.canvas.Canvas at 0x7f03ae59a5d0>,
 <toyplot.coordinates.Cartesian at 0x7f03ada12b10>,
 <toyplot.mark.Point at 0x7f03adfcfa50>)
```
