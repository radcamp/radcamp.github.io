...
echo "Unpack simulated data"
mkdir ipyrad-workshop
cd ipyrad-workshop
tar -xzf ~/tests/ipsimdata.tar.gz

echo "------- ipyrad params file (v.0.9.13)-------------------------------------------
...
0, 75, 0, 75                     ## [25] [trim_reads]: Trim raw read edges (R1>, <R1, R2>, <R2) (see docs)
...
ipyrad -p params-peddrad.txt -s 1234567
