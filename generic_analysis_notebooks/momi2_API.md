...
![jpg](momi2_API_files/momi2_API_000_SFS.jpg)
...
![png](momi2_API_files/momi2_API_01_ToyModel.png)
...
fig = momi.DemographyPlot(
    ...
    linthreshy=1.5e5)
```
![png](momi2_API_files/momi2_API_02_ToyModel_Migration.png)
...
fig = momi.DemographyPlot(
    ...
    linthreshy=1.5e5)
```
![png](momi2_API_files/momi2_API_03_Inference_tdiv.png)
...
fig = momi.DemographyPlot(
    ...
    linthreshy=1.5e5)
```
![png](momi2_API_files/momi2_API_04_Inference_sizes.png)
...
fig = momi.DemographyPlot(
    ...
    linthreshy=1.5e5)
```
![png](momi2_API_files/momi2_API_05_Inference_migration.png)
...
```
![png](momi2_API_files/momi2_API_06_Bootstrap_tdiv.png)
